 ...
 */
public class fmprobar extends javax.swing.JFrame {

    /**
     * Creates new form fmprobar
     */
    public fmprobar() {
        initComponents();
    }
    ...
    private void btnprobarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprobarActionPerformed
        ...
        if(cn==null){
            JOptionPane.showMessageDialog(null, "No conectado");
             ...
             JOptionPane.showMessageDialog(null, "Estamos conectados");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fmprobar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
